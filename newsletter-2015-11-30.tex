...
\usepackage{lipsum}
\backgroundsetup{%
  scale=3.5,       %% change accordingly
  angle=0,       %% change accordingly
  opacity=.06,    %% change accordingly
  color =black,  %% change accordingly
  contents={\begin{tikzpicture}[remember picture,overlay]
        \node at ([yshift=11pt,xshift=5pt]current page.center) {\includegraphics[width=5cm]{iboard.png}};    %% yshift and xshift for example only
    \end{tikzpicture}}
}
