...
\vspace{-0.4cm}
\hypertarget{thirdnews}{\heading{Chairman Platform}{6pt}}
As chairman I will promise to make floor great again and restore us to our previous glory. Below is my 10 step process to fixing floor. \\
\begin{enumerate}
\item We will stop all acceptance of GDD freshmen until we find out what the hell is going on here
\\
\item Re-enable the magnets doors to stop the flow of randos onto our floor
\\
\item 
\end{enumerate}
