...
\item \textbf{Andrew Jeddeloh's Birthday} Feb. 2 \\
	Happy 21st birthday Jello, don't go too crazy :P
\\
\item \textbf{History Discussion} Feb. 2 9pm \\
	The discussion this week is about if we should encode into the constitution rules for packet quests. We all know that you have a strong opinion on this topic so plan on attending. 
\\
\item \textbf{OpCommathon} Feb. 6 \\
	Come hack with all the RTPs and they might actually help you with your problems!
\\
\item \textbf{Hipster Movie Night} Feb. 6 10pm \\
\item \textbf{Super Bowl L} Feb. 7 6:30pm \\
	Come watch sports-ball with the rest of floor. House meeting is canceled due to this
\\
\end{enumerate}
