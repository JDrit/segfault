...
\item \textbf{Maxime Bourgeois's Birthday} Feb. 17 \\
	Happy birthday Max, you da man!
\\
\item \textbf{Nick Breeman} Feb. 19 \\
	Happy birthday Nick, now go study for the psych test!
\\
\end{enumerate}
