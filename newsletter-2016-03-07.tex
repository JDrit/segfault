...
\cfoot{"I could see Zukjo getting out the leather handcuffs" - Sam}
...
\textbf{Judaical Bias Amendment} \\
Add clause to judicial board formation to eliminate E-Board members who may be biased in the investigation from the process
\\
\\
\textbf{E-Board Oversight to the Judicials} \\
Change the way judicial board decisions are implemented
\\
%-----------------------------------------------------------
