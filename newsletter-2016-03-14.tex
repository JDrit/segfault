...
\item \textbf{Cutting and Crimping} Mar. 15, 7pm \\
	Marc will be giving a seminar on how to be a OCD ANSA major.
\\
\item \textbf{SPRING BREAK} Mar. 19 - Mar. 27 \\
	FINALLY!!
\\
\item \textbf{War Paint Challenge} April. 1 8pm \\
	with E-House!!
\\
\end{enumerate}

\textbf{Amendment Results:} 

Bias in the judicial process: \textbf{PASSED}

E-Board oversight for judicials: \textbf{FAILED}
