...
\cfoot{"Henry your door is always open, just like your asshole" - 
Spencer (spencerk)}
...
Nothing, go home and spend time with your family, or try to avoid them.
I don't know your family situation.

\centerline {\rule{.75\linewidth}{.25pt}} % Horizontal line
\textbf{Scala} \\
One of the best languages out there right now is called Scala. It is able to
effectively combine object-oriented design with functional programming. Scala
runs on top of the JVM which gives you 100\% binary compatibility with a wide
array of library support and resources.  Look forward to the next major release
2.12!\\

\textbf{Python 3.5} \\
Python 3.5, which was release in the middle of September, has several cool new
features. 

\begin{enumerate}[leftmargin=0cm,itemindent=.5cm]
\item \textbf{Coroutines with async and await syntax (PEP 492)} \\
This greatly improves support for asynchronous programming by adding 
coroutines into the language 
\\
\item \textbf{type hints (PEP 484)} \\
While type hints have been in the language since 3.0, however the semantics of
annotations has been left undefined. This introduces a provisional module to 
provide these standard definitions and tools, along with some conventions for
...
\item \textbf{matrix multiplication (PEP 465)} \\
