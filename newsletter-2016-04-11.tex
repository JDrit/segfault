...
\vspace{-0.5cm}\begin{minipage}[t]{.45\linewidth} % Mini page taking up 35% of the actual page
...
%----------------------------------------------------------------------------------------
%
\begin{minipage}[t]{.53\linewidth} % Mini page taking up 61% of the actual page
\vspace{-0.4cm}
