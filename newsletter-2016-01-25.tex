...
\item \hyperlink{secondnews}{Uncovering the Secrets of the 
Illuminati: Exposing Their Identities and Practices}
...
\textbf{Birthdays We Missed:}
\begin{itemize}[leftmargin=0.2cm]
\item \textbf{Sam Heckle} Jan. 1, 1997
\item \textbf{Robert Glossop} Jan. 4, 1994 
\item \textbf{Eric Knapik} Jan. 11, 1995 
\item \textbf{Braden Bowdish} Jan. 17, 1997
\item \textbf{Ryan Buzzell} Jan. 20, 1993 
\end{itemize}
...
\item \textbf{GDC Talks} Jan 27, 10pm \\
	Liam is once again hosting GDC talks, let him know if you are interested in any talk in particular.
\\
\item \textbf{Hipster Movie Night} Jan 30, 10pm \\
\end{enumerate}
...
\begin{quote}
\centering
\textbf{\textit{author: \censor{John Doe} }}
\end{quote}
